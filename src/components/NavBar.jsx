  ...
  return (
    <>
      <header className={scrolled ? "header scrolled" : "header"}>
        <div className="inner">
          <Link href="/#home" className="logo">SimplyAG</Link>
      ...
      <style jsx global>{`
        :root { --gold: #D4AF37; --navy-rgb: 30,41,59; }
        ...
        .cta {
          padding: 0.45rem 1.1rem; border: 2px solid var(--gold);
          border-radius: 9999px; color: var(--gold);
          text-transform: uppercase; letter-spacing: 0.1em;
          font-weight: 600; font-size: 0.85rem;
          text-decoration: none; transition: background 0.2s, color 0.2s;
        }
        .cta:hover { background: var(--gold); color: #1e293b; }
        ...
        @media (max-width: 768px) {
          ...
          .mobile .nav-link { padding: 0.5rem 0; }
        }
      `}</style>
    </>
  )
